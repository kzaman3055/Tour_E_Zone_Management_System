        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{route('restaurant.update',$editData->id)}}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <h5>Breakfast Time<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="time" name="breakfast" class="form-control"
                                                    value="{{$editData->breakfast}}" required="">
                                        ...
                                        <div class="form-group">
                                            <h5>Launch Time<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="time" name="launch" class="form-control"
                                                    value="{{$editData->launch}}" required="">
                                        ...
                                        <div class="form-group">
                                            <h5>Dinner Time<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="time" name="dinner" class="form-control"
                                                    value="{{$editData->dinner}}" required="">
